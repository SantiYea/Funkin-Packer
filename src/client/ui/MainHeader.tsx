			...
			<div className="main-header back-900 color-white">
				<div className='left-align'>
					...
					<div className='main-header-github'>
						<a href="https://github.com/ShadowEngineTeam/Funkin-Packer" target="_blank">
							<img src="static/images/github-mark-white.png" height="25" alt="Github" />
						</a>
					</div>
					<div className='main-header-bmc'>
						<a href="https://coff.ee/homuhomu833" target="_blank">
							<img src="static/images/bmc.png" height="25" alt="Buy Me a Coffee" />
						</a>
					</div>
				</div>
