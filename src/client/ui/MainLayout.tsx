...
class MainLayout extends React.Component<Props, State> {
  ...
  override componentDidMount = () => {
    ...
    Observer.on(
      GLOBAL_EVENT.SHOW_EDIT_CUSTOM_EXPORTER,
      this.showEditCustomExporter,
      this,
    );
    Observer.on(
      GLOBAL_EVENT.HIDE_EDIT_CUSTOM_EXPORTER,
      this.hideEditCustomExporter,
      this,
    );
  ...
  override componentWillUnmount = () => {
    ...
    Observer.off(
      GLOBAL_EVENT.SHOW_SHEET_SPLITTER,
      this.showSheetSplitter,
      this,
    );
    Observer.off(
      GLOBAL_EVENT.HIDE_SHEET_SPLITTER,
      this.hideSheetSplitter,
      this,
    );
  };
  ...
  showMessage = (content: string, buttons?: ButtonData[]) => {
    ...
    let box = (
      <MessageBox
        content={content}
        buttons={buttons}
        closeCallback={this.closeMessage}
      />
    );
  ...
  override render() {
    const rtlClass = I18.currentLanguage.isRtl ? " rtl" : "";
    return (
      <div className={"main-wrapper" + rtlClass}>
        <MainHeader />
